...
<br>This function cannot be parallelized since it sequentially gets each element one at a time. 
```python
...
The for loops make it so that the function must run sequentially, making this method inefficient.
